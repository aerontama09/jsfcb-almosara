...
document.addEventListener('touchend', (e) => {
	...
	if(Math.abs(diffX) > Math.abs(diffY)){
		...
		{ // If diffX is a zero or negative number
			slideRight();
			setTwo();
		}
	} 
		...
		{ // If diffY is a zero or negative number
			slideDown();
			setTwo();
		}
	}
	...
	/*(1, 1) (15, 2)
	diffY : 1 - 15 = -14 -> 14 (slideLeft or slideRight)
	diffX : 1 - 2 = 1 (slideUp or slideDown)*/
	document.getElementById("score").innerText = score;
...
document.addEventListener('touchmove', (e) => {
	...
	e.preventDefault(); // This line prevent scrolling
